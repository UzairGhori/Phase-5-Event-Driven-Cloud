# Task: T-G001 — Correlation ID middleware
# Spec: NFR-026, Spec §8.3 (correlation_id in event envelope)
# Plan: §7.4 (Correlation ID Propagation)
...
class CorrelationMiddleware(BaseHTTPMiddleware):
    ...
    Plan §7.4: Generated at ingress if not present, passed through all
