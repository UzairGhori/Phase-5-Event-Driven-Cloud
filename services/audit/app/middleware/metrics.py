# Task: T-A020 — Prometheus metrics middleware for Audit Service
# Spec: NFR-027
...
audit_logs_persisted = Counter(
    "audit_logs_persisted_total",
    "Audit log entries persisted to database",
    ["service"],
)
